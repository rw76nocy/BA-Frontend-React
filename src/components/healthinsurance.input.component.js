                ...
                <div className="input-create-container">
                    ...
                    <span className="input-sub-row">
                        <div className="input-half-row-first">
                            ...
                            <input className="input-input" name="holder" id="holder" type="text" placeholder="Versichert über"/>
                        </div>
                        <div className="input-half-row-second">
                            <label className="input-label" htmlFor="number"><b>Versichertennummer</b></label>
                            <input className="input-input" name="number" id="number" type="text" placeholder="Versichertennummer"/>
                        </div>
                    </span>
